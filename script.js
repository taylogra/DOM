...
let init = function(){
    ...
    //to use this method we first need to create a variable that represents the element we wish to add

    //let btn = document.createElement( "BUTTON"); //This only creates the element it does not add it tot the page
    //btn = <button></button>
...
let createTable = function(){
    ...
    rowHeading4 = document.innerText = "Seniors";
